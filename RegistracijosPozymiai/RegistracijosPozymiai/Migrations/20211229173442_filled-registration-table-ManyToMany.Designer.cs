...
namespace RegistracijosPozymiai.Migrations
{
    ...
    [Migration("20211229173442_filled-registration-table-ManyToMany")]
    partial class filledregistrationtableManyToMany
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RegistracijosPozymiai.Models.FormedRegistration", b =>
                {
                    b.Property<int>("RegAttributeId")
                        .HasColumnType("int");

                    b.Property<int>("RegValueId")
                        .HasColumnType("int");

                    b.HasKey("RegAttributeId", "RegValueId");
            ...
            modelBuilder.Entity("RegistracijosPozymiai.Models.FormedRegistration", b =>
                {
                    b.HasOne("RegistracijosPozymiai.Models.RegAttribute", "RegAttribute")
                        .WithMany()
                        .HasForeignKey("RegAttributeId")
